...
@IonicPage()
@Component({
  selector: 'page-expert-introduce-list',
  templateUrl: 'expert-introduce-list.html',
})
export class ExpertIntroduceList extends BaseClinicPage {
  experts;
  searchExpert = [];
  searchStr;
  searchValue:any = '';
  ...
  constructor(public app: AppConfig,public cacheService: CacheService, public navCtrl: NavController, public navParams: NavParams,
    ...
    this.searchExpert = this.handleData(this.experts);
  }

...
@IonicPage()
@Component({
  selector: 'page-fee-record',
  templateUrl: 'fee-record.html',
  providers: [AccountService]
})
export class FeeRecordPage extends BaseRecordPage {
  ...
  getServiceData(infiniteScroll?: any,refresh?) {
    ...
    this.httpService.getFeeForGFE(this.member.aesId,this.yearMonth)
      .subscribe(json => {
        if (json.success) {
